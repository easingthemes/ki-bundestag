...
const ACTIONS: ActionRow[] = [
  {
    ...
    type: "AI — Haiku",
    triggeredBy: "Parteiagent — täglich",
    summary: "Beantragt neue Gesetzgebung (max 1/Runde, Fraktion erforderlich)",
  ...
  },
  {
    ...
    type: "AI — Haiku",
    triggeredBy: "Parteiagent — täglich",
    summary: "Stimmt über alle Gesetze in 3. Lesung ab (Pflicht)",
  ...
  },
  {
    ...
    type: "AI — Haiku",
    triggeredBy: "Parteiagent — täglich",
    summary: "Änderungsantrag zu einem Gesetz in 2. Lesung (max 1/Runde, Fraktion erforderlich)",
  ...
  },
  {
    ...
    type: "AI — Haiku",
    triggeredBy: "Parteiagent — täglich",
    summary: "Reicht Antrag oder Entschließung ein (max 1/Runde)",
  ...
  },
  {
    ...
    category: "Kontrolle",
    type: "AI — Haiku",
    triggeredBy: "Parteiagent — täglich (nur Opposition + Fraktion)",
    summary: "Reicht Kleine oder Große Anfrage an ein Ministerium ein (max 1/Runde)",
  ...
  },
  {
    ...
    category: "Verfassung",
    type: "AI — Haiku",
    triggeredBy: "Jede Partei mit Fraktion (max 1/Tag global)",
    summary: "Klagt gegen ein verabschiedetes Gesetz vor dem Bundesverfassungsgericht",
  ...
  },
  {
    ...
    type: "AI — Haiku",
    triggeredBy: "Parteiagent — täglich (max 1/Runde)",
    summary: "Gibt eine öffentliche politische Stellungnahme ab",
  ...
  },
  {
    ...
    category: "Kommunikation",
    type: "AI — Haiku",
    triggeredBy: "Parteiagent — täglich während Wahlkampf",
    summary: "Gibt ein Wahlkampfversprechen während der Wahlperiode ab",
  ...
  },
  {
    ...
    category: "Regierung",
    type: "AI — Haiku",
    triggeredBy: "Verhandlungsagent — 1 Runde/Tag für 3 Tage nach der Wahl",
    summary: "Benennt Koalitionsposition, Zugeständnisse und akzeptable Partner",
  ...
  },
  {
    ...
    type: "AI — Haiku",
    triggeredBy: "Täglich — max 3 älteste offene Fragen",
    summary: "Beantwortet Bürgerfragen als Parteiführung",
  ...
  },
  {
    ...
    category: "Kontrolle",
    type: "AI — Haiku",
    triggeredBy: "Täglich — max 2 älteste offene Anfragen",
    summary: "Beantwortet parlamentarische Anfragen als zuständiger Minister",
  ...
  },
  {
    ...
    category: "Medien",
    type: "AI — Haiku",
    triggeredBy: "Ende jedes Simulationstages (nur berichtenswerte Ereignisse)",
    summary: "Schreibt 2–3 Zeitungsartikel von 3 Medienredaktionen",
  ...
  },
  {
    ...
    category: "Beteiligung",
    type: "AI — Haiku",
    triggeredBy: "Wöchentlich (Tag % 7) — 1 Kontextumfrage + 1 Parteipräferenzumfrage",
    summary: "Erstellt eine kontextbezogene Meinungsumfrage",
  ...
  },
  {
    ...
    category: "Beteiligung",
    type: "AI — Haiku",
    triggeredBy: "Alle 30 Tage",
    summary: "Erstellt eine Volksabstimmung mit wirtschaftlicher Auswirkung",
  ...
  },
  {
    ...
    category: "Regierung",
    type: "Algorithmic",
    triggeredBy: "Alle 60 Tage (Tag % 60)",
    summary: "Zählt Parlamentsstimmen zum jährlichen 300-Mrd.-EUR-Haushalt",
  ...
  },
  {
    ...
    category: "Gesetzgebung",
    type: "Algorithmic",
    triggeredBy: "Auto — Gesetzentwurf erreicht Ausschuss",
    summary: "Ausschuss gibt Empfehlung: Annahme/Änderung/Ablehnung",
  ...
  },
  {
    ...
    category: "Gesetzgebung",
    type: "Algorithmic",
    triggeredBy: "Auto — jeder Änderungsantrag in 2. Lesung",
    summary: "Algorithmische Abstimmung über Änderungsanträge",
  ...
  },
  {
    ...
    category: "Verfassung",
    type: "Algorithmic",
    triggeredBy: "Pro verabschiedetem Gesetz",
    summary: "Bundespräsident kann umstrittene Gesetze ablehnen",
  ...
  },
  {
    ...
    category: "Verfassung",
    type: "Algorithmic",
    triggeredBy: "Pro Verfassungsbeschwerde",
    summary: "Gericht urteilt mit 30% Chance auf Verfassungswidrigkeit",
  ...
  },
  {
    ...
    category: "Gesetzgebung",
    type: "Algorithmic",
    triggeredBy: "Pro Antrag — gleicher Tag",
    summary: "Algorithmische Abstimmung am selben Tag über Anträge",
  ...
  },
  {
    ...
    category: "Ereignisse",
    type: "Algorithmic",
    triggeredBy: "Tägliche Prüfung",
    summary: "Löst zufällig Krisen aus 8 deutschen Vorlagen aus",
  ...
  },
  {
    ...
    type: "Algorithmic",
    triggeredBy: "Täglich",
    summary: "Wendet Mean-Reversion + Rauschen auf alle 4 Wirtschaftsindikatoren an",
  ...
  },
  {
    ...
    type: "Algorithmic",
    triggeredBy: "Täglich",
    summary: "Zieht öffentliche Stimmung per Mean-Reversion zur Baseline",
  ...
  },
  {
    ...
    category: "Wirtschaft",
    type: "Algorithmic",
    triggeredBy: "Täglich pro Partei",
    summary: "Fügt kleine Zufallsschwankungen zur Parteizustimmung hinzu",
  ...
  },
  {
    ...
    category: "Medien",
    type: "Algorithmic",
    triggeredBy: "Täglich — nach Presseartikel-Erstellung",
    summary: "Wendet Medieneinfluss auf öffentliche Stimmung an",
  ...
  },
  {
    ...
    category: "Beteiligung",
    type: "Algorithmic",
    triggeredBy: "Auto — am Schlusstag",
    summary: "Prüft Quorum und wendet wirtschaftliche Auswirkung an",
      ...
      <Card>
        <CardContent className="p-0 overflow-x-auto">
          <table className="w-full border-collapse text-sm min-w-[600px]">
            <thead>
              <tr>
                <th className="text-left px-3 py-2.5 bg-muted/50 border-b-2 border-border text-xs uppercase text-muted-foreground font-semibold">{t("actionsReference.spalteAction")}</th>
                <th className="text-left px-3 py-2.5 bg-muted/50 border-b-2 border-border text-xs uppercase text-muted-foreground font-semibold">{t("actionsReference.spalteCategory")}</th>
                <th className="text-left px-3 py-2.5 bg-muted/50 border-b-2 border-border text-xs uppercase text-muted-foreground font-semibold">{t("actionsReference.spalteType")}</th>
                <th className="text-left px-3 py-2.5 bg-muted/50 border-b-2 border-border text-xs uppercase text-muted-foreground font-semibold">{t("actionsReference.spalteTriggeredBy")}</th>
                <th className="text-left px-3 py-2.5 bg-muted/50 border-b-2 border-border text-xs uppercase text-muted-foreground font-semibold">{t("actionsReference.spalteDescription")}</th>
