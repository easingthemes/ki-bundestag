      ...
      <Card className="mb-5">
        <CardContent className="p-5 leading-[1.7]">
          ...
          <ol className="my-2 ml-6 list-decimal">
            ...
            <li className="mb-1"><strong>Wahlkampf</strong> — Parteien machen Wahlversprechen und kämpfen um Unterstützung (21 Tage ab Ankündigung, aktiver Wahlkampf beginnt nach 7 Tagen).</li>
