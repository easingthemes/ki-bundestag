...
- [Bundestag Reference](research/bundestag-reference.md) — German parliamentary rules
- [Abgeordnetenwatch Features](research/abgeordnetenwatch-features.md) — Implementation record
- [Abgeordnetenwatch API](research/abgeordnetenwatch-api.md) — External API reference
- [Marketing Strategy](marketing/strategy.md) — Launch plan
- [Roadmap](todo/README.md) — What's done + what's open
